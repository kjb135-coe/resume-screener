...
- **The cascade is not measurably better than one call.** Three agents plus an arbiter scored 0.847; a single call scored 0.821 — inside the noise band, and an exact 10-10 tie when paired per candidate. Single-pass is 11% cheaper and 38% faster. Kept anyway, for the three independent rationales, but the accuracy case for it is absent and that is written down rather than buried.
