...
│   ├── bakeoff__luna-effort-low__run1.json One scripts/bakeoff.py run for one model arm. See docs/BAKEOFF.md.
│   ├── bakeoff__luna-effort-low__run2.json One scripts/bakeoff.py run for one model arm. See docs/BAKEOFF.md.
│   ├── bakeoff__luna-effort-low__run3.json One scripts/bakeoff.py run for one model arm. See docs/BAKEOFF.md.
...
│   ├── overview/                    A single self-contained results page, for readers who will not clone anything.
