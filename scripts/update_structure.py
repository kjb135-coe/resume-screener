...
DESCRIPTIONS: dict[str, str] = {
    ...
    "docs/BIAS_AUDIT.md": "Does the score change when only the name changes? Paired name-swap test and its limits.",
    ...
    "scripts/bias_audit.py": "Swaps only the candidate name and re-scores, to test for a name effect.",
